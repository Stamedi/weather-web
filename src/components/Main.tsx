...
const Main = ({ weatherData = {} }: any) => {
  ...
  return (
    <main className="container mx-auto relative mt-10 w-full h-screen px-10 ">
  ...
  w-xl"
      ...
      <section className=" absolute p-16 text-white text-shadow ">
        ...
        <div className="flex-col justify-center justify-items-center items-center bg-white bg-opacity-40 p-3 rounded-xl mt-8 shadow-lg">
          <img
            className="w-32 object-contain self-center"
            src={`https://openweathermap.org/img/wn/${icon}@2x.png`}
            alt="weather-icon"
          />
          <h4 className="text-xl ">Weather Type: {main}</h4>
          <h4 className="text-xl pt-3">Wind Speed: {Math.round(wind.speed * 3.6)} km/h</h4>
        </div>
      </section>
    </main>
  );
